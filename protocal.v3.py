...
try:
    ...
    ###############################################
            ...
            # ax.scatter( targx[i], targy[i],targz[i], s=100, color="r")
            # ax.plot_surface(x_matrix, y_matrix,z_matrix, cmap='viridis', edgecolor='none')
            #
            # plt.show()
       ...
       targx_norm = 200 * targx / norm
       targy_norm = 200 * targy / norm
       targz_norm = 200 * targz / norm
